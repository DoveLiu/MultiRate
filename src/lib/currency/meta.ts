...
export const CURRENCY_OPTIONS: CurrencyMeta[] = [
  ...
  { code: "THB", nameZh: "泰幣", nameEn: "Thai Baht", flag: "🇹🇭", sortOrder: 12 },
  { code: "PHP", nameZh: "菲國比索", nameEn: "Philippine Peso", flag: "🇵🇭", sortOrder: 13 },
  { code: "IDR", nameZh: "印尼幣", nameEn: "Indonesian Rupiah", flag: "🇮🇩", sortOrder: 14 },
